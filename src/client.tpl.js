...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const NEU_CSS = [
			"body[data-dsh-neu] {",
			"  --dsh-neu-raise: inset 0 1px 0 rgba(255, 255, 255, 0.65), 6px 6px 14px rgba(122, 118, 108, 0.22), -6px -6px 14px rgba(255, 255, 255, 0.85);",
			"  --dsh-neu-raise-sm: inset 0 1px 0 rgba(255, 255, 255, 0.6), 3px 3px 8px rgba(122, 118, 108, 0.18), -3px -3px 8px rgba(255, 255, 255, 0.75);",
			"  --dsh-neu-inset: inset 3px 3px 8px rgba(122, 118, 108, 0.16), inset -3px -3px 8px rgba(255, 255, 255, 0.7);",
			"  --dsh-neu-inset-focus: inset 4px 4px 10px rgba(122, 118, 108, 0.22), inset -4px -4px 10px rgba(255, 255, 255, 0.8);",
			...
			"  background-image:",
			"    radial-gradient(1400px 900px at 50% -8%, rgba(255, 255, 255, 0.6), transparent 62%),",
			"    radial-gradient(900px 600px at 85% 110%, rgba(255, 255, 255, 0.22), transparent 60%),",
			...
			"  --dsh-neu-raise: inset 0 1px 0 rgba(255, 255, 255, 0.09), 6px 6px 14px rgba(0, 0, 0, 0.45), -6px -6px 14px rgba(255, 255, 255, 0.05);",
			"  --dsh-neu-raise-sm: inset 0 1px 0 rgba(255, 255, 255, 0.08), 3px 3px 8px rgba(0, 0, 0, 0.4), -3px -3px 8px rgba(255, 255, 255, 0.04);",
			...
			"  background-image:",
			"    radial-gradient(1400px 900px at 50% -8%, rgba(255, 255, 255, 0.045), transparent 62%),",
			"    radial-gradient(900px 600px at 85% 110%, rgba(0, 0, 0, 0.35), transparent 60%),",
			...
			"  background-image: linear-gradient(145deg, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0) 42%);",
			"}",
			...
			"  background-image: linear-gradient(145deg, rgba(255, 255, 255, 0.055), rgba(255, 255, 255, 0) 42%);",
			"}",
			...
			"  background-image: linear-gradient(145deg, rgba(255, 255, 255, 0.55), rgba(255, 255, 255, 0) 42%);",
			"  border-radius: 12px;",
			"  box-shadow: var(--dsh-neu-raise-sm);",
			"}",
			"body[data-dsh-neu][data-ds-dark-theme] [data-tool] {",
			"  background-image: linear-gradient(145deg, rgba(255, 255, 255, 0.06), rgba(255, 255, 255, 0) 42%);",
			"}",
