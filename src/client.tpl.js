...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const NEU_CSS = [
			...
			"   rounded corners, so outer call and inner sub-call read as one",
			"   language instead of a floating row next to a card (ToolRow's",
			"   data-tool + ToolCallTree's data-subcalls — ui-tool sources). */",
